...
<div class="cont_principal">
  ...
  <div class="cont_text_inputs">
    <div> DISPLAY NAME  <input value = "<?php echo isset($presets['display_name']) ? $presets['display_name'] : ''; ?>" type="text" class="input_form_sign " id = "display_name" name="display_name" />
